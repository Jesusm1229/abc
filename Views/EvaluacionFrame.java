...
public class EvaluacionFrame extends javax.swing.JFrame {
        ...
        switch(categoria){
            ...
            case 0: 
                        ...
                        if(acierto == -1 || acierto == 0){
                            ...
                            int posRespuestaCorrecta = rnd.nextInt(3);
    ...
    public int verificarResultadosOfertaEmpleo(){
        ...
        if(!categoriasSeleccionadas.isEmpty())
            return categoriasSeleccionadas.get(rnd.nextInt(categoriasSeleccionadas.size()));
    ...
    private void initComponents() {
        ...
        titleEvaluacion.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        titleEvaluacion.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jPPage1.add(titleEvaluacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 90, 770, 60));
        ...
        opcion1_radiobutton.setText("<html>");
        opcion1_radiobutton.setContentAreaFilled(false);
        opcion1_radiobutton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        opcion2_radiobutton.setText("<html>");
        opcion2_radiobutton.setContentAreaFilled(false);
        opcion2_radiobutton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        opcion3_radiobutton.setText("<html>");
        opcion3_radiobutton.setContentAreaFilled(false);
        opcion3_radiobutton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        opcion4_radiobutton.setText("<html>");
        opcion4_radiobutton.setContentAreaFilled(false);
        opcion4_radiobutton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
